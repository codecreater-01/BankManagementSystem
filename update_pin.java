...
public class update_pin implements ActionListener{
    Label l1,l2,l3;
    TextField t1;
    Button b0,b1;
    static int n;
    public update_pin(){
    Frame f=new Frame("Update Address");
    ...
    b0=new Button("BACK!!");
    b0.setBounds(20, 45, 100, 50);
    b0.setFont(d);
    l1=new Label("UPDATE PIN");
